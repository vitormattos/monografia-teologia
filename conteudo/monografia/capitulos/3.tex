...
O tipo de software utilizado pela igreja não é uma escolha meramente técnica ou funcional, é também uma decisão ética, espiritual e pastoral. Optar por soluções proprietárias, que não oferecem transparência sobre o tratamento dos dados, que impõem barreiras ao acesso ou que podem romper a qualquer momento com os interesses da comunidade, significa submeter a missão eclesiástica a interesses comerciais e, muitas vezes, incompatíveis com os valores do Reino de Deus.

O software livre, por outro lado, oferece liberdade de uso, estudo, modificação e distribuição. Isso permite que a igreja tenha pleno controle sobre os sistemas que utiliza, garantindo maior segurança, proteção da privacidade dos fiéis e conformidade com princípios éticos e legais, incluindo normas de proteção de dados como a \gls{lgpd} fortalecendo a soberania tecnológica da comunidade, reduzindo a dependência de grandes corporações e permitindo adaptações conforme as necessidades.
