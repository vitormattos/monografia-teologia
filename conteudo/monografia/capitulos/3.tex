...
No ambiente digital, é necessário que a igreja atue com discernimento e zelo, especialmente diante dos riscos de exposição indevida e comunicação ofensiva que possam comprometer a comunhão e a edificação mútua. Isso inclui a moderação de comentários durante transmissões ao vivo, o cuidado com a exposição de informações pessoais em chats, redes sociais ou grupos de mensagens, e a orientação aos membros sobre a forma adequada de compartilhar trechos dos cultos e eventos.
